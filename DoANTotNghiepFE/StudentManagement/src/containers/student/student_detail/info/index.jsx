...
const StudentDetailInfo = ({ studentDetail, handleOpenChangeInfo }) => {

  return (
    <div className="detail-block">
      <div className="detail-left">
        <img
          src={studentDetail?.image ? Api.BASE_URL + studentDetail?.image : 'https://icdn.isrgrajan.com/in/2018/03/photo-1496509218134-fad73128e572-696x464.jpg'} />
      </div>
