...
const StudentManager = () => {
  ...
  const handleSearchStudent = () => {
    ...
    let isValid =
      searchPayload.studentCode !== '' ||
      searchPayload.courseId != null ||
      searchPayload.classroomId != null ||
      searchPayload.pointStart != null ||
      searchPayload.pointEnd != null;
  ...
  const handleCreateStudent = () => {
    // validate input not blank
    if (!payloadCreate.studentName && !payloadCreate.idCourse && !payloadCreate.idClass) {
      toast.info('Vui lòng nhập thông tin sinh viên');
      return;
    }

    dispatch(
      StudentActions.createStudentRequest({
        ...payloadCreate,
  ...
  const handleDeleteStudent = () => {
    dispatch(
      StudentActions.deleteStudentRequest({
  ...
  const handlePageChange = (pageNumber) => {
    dispatch(
      StudentActions.searchStudentRequest({
        ...searchPayload,
  ...
  return (
    <div className={'student-manager-page'}>
      <div className={'student-id-box'}>
        <Input
          value={searchPayload.studentCode}
      ...
      <div className={'select-box-container'}>
        ...
        <div className={'input-container'}>
          ...
          <div className={'input-box'}>
            <p>Từ</p>
            <Input
              value={searchPayload.pointStart}
      ...
      <div className={'title-container'}>
        ...
        {role === AuthKeys.ROLE_ADMIN && <Button title={'Thêm sinh viên'} onClick={() => setShowCreate(true)} />}
      </div>
        ...
        <MDBTable striped hover>
          <MDBTableHead>
            <tr>
              ...
              <th>Lớp</th>
              <th>TB điểm TL</th>
              {role === AuthKeys.ROLE_ADMIN && <th></th>}
            </tr>
          </MDBTableHead>
          <MDBTableBody>
            {students &&
      ...
      {/* Modal show create */}
      <MDBModal open={showCreate} tabIndex="-1" onClose={() => handleCloseCreate()}>
        <MDBModalDialog size="fullscreen-sm-down">
          <MDBModalContent>
            <MDBModalHeader>
              <MDBModalTitle>Thêm sinh viên</MDBModalTitle>
              <MDBBtn className="btn-close" color="none" onClick={() => handleCloseCreate()}></MDBBtn>
            </MDBModalHeader>
            <MDBModalBody>
              <div>
                <Input
                  value={payloadCreate.username}
                ...
                <Input
                  value={payloadCreate.studentName}
            ...
            <MDBModalBody>
              ...
              <Input
                ...
                <MDBFile
                  label="Hình ảnh"
                  id="customFile"
                  onChange={(e) => setPayloadEdit({ ...payloadEdit, studentImage: e.target.files[0] })}
                />
