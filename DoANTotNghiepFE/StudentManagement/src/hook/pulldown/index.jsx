...
const Dropdown = ({ items, value, setSelected, ignores, label, customStyle, error, isDisable }) => {
  return <div style={{ ...customStyle }}>
    <CDropdown style={{ display: 'block', border: error ? '1px solid red' : '1px solid #F5F5F5' }}>
      ...
      <CDropdownMenu style={{ width: '100%', border: '1px solid #F5F5F5', maxHeight: '200px', overflowX: 'auto' }}>
        {items
